 ...
 */
final class Version20220511134444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz ADD time TIME DEFAULT NULL, DROP start_time');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz ADD start_time TIME DEFAULT \'NULL\', DROP time, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nombrequestion nombrequestion VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
