 ...
 */
final class Version20220413130524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `leave` DROP number_of_day');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `leave` ADD number_of_day INT NOT NULL, CHANGE status status VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
