 ...
 */
final class Version20220324132917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sprint ADD task_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sprint ADD CONSTRAINT FK_EF8055B78DB60186 FOREIGN KEY (task_id) REFERENCES tasks (id)');
        $this->addSql('CREATE INDEX IDX_EF8055B78DB60186 ON sprint (task_id)');
        $this->addSql('ALTER TABLE tasks CHANGE priorite priorite VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sprint DROP FOREIGN KEY FK_EF8055B78DB60186');
        $this->addSql('DROP INDEX IDX_EF8055B78DB60186 ON sprint');
        $this->addSql('ALTER TABLE sprint DROP task_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE duree duree VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE status status VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
