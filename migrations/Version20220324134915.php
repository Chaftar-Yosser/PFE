 ...
 */
final class Version20220324134915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks ADD sprint_id INT DEFAULT NULL, CHANGE priorite priorite VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE tasks ADD CONSTRAINT FK_505865978C24077B FOREIGN KEY (sprint_id) REFERENCES sprint (id)');
